...
// [getMarkerPos _vehicleVarName,600,360,80,60,360,_vehicle,_vhome] execvm "paramsplus\fly_circle_H.sqf"; //
/////////////////////////////////////////////////////////////////////////////////////////////
...
/*
hintSilent format ["Center: %1, Radius: %2, Amount: %3, FlyInHeight: %4, Angle: %5, Inc: %6, Vehicle: %7, Home: %8, Varname: %9",_centrepos,_rad,_many,_height,_ang,_inc,_vehicle,_vhome,_vVarname];
...
_wp0 setWaypointStatements ["true", "[(vehicle this),100,80] execVM 'paramsplus\heliSpeedLimiter.sqf'"];
...
while {(count (waypoints (group _vehicle))) > 0} do {
	...
	[_vehicle,200,80] execVM "paramsplus\heliSpeedLimiter.sqf";
