// "SettingsAdjustments_Group.sqf" //
private ["_unit","_BI_CP_SettingsAdjustments"];
...
switch (_BI_CP_SettingsAdjustments) do
{
	case 1: {
				...
				switch true do 
				
					{
						case (side _unit isEqualTo WEST) :  {
							...
							[playerSide, "HQ"] commandChat format ["%1, Settings Adjustments Not Enabled!",name _unit];
