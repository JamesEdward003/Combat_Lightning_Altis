...
_airType = switch (_sideUnit) do 
	{
		case west: 			{"B_Heli_Transport_03_F"};
		case east: 			{"B_Heli_Transport_03_black_F"};
		case resistance: 	{"B_Heli_Transport_03_black_F"};
		case civilian: 		{"B_Heli_Transport_03_F"};
	};
