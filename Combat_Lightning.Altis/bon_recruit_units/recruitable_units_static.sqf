...
switch {typeOf player} do {
	...
	case "B_Captain_Pettka_F": {bon_recruit_recruitableunits = ["B_Captain_Pettka_F","B_Captain_Jay_F","B_CTRG_soldier_GL_LAT_F","B_Story_Protagonist_F","B_Story_Pilot_F","B_CTRG_soldier_AR_A_F","B_CTRG_soldier_M_medic_F","B_CTRG_soldier_engineer_exp_F","B_CTRG_Sharphooter_F","B_Story_SF_Captain_F"];};

	case "B_W_Soldier_SL_F": {bon_recruit_recruitableunits = ["B_W_Soldier_F","B_W_Soldier_LAT_F","B_CTRG_soldier_GL_LAT_F","B_W_soldier_M_F","B_W_Soldier_TL_F","B_W_Soldier_AR_F","B_W_Soldier_A_F","B_W_Medic_F","B_W_Soldier_GL_F","B_W_Soldier_Exp_F","B_W_Engineer_F"];};
};
