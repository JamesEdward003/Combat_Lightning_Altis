...
if(_queuecount > 0) then {
	...
	hint parseText format["<t size='1.0' font='PuristaMedium' color='#00ffee'>%1</t> added to queue.",_typename];
};
...
hint parseText format["Processing a <t size='1.0' font='PuristaMedium' color='#00ffee'>%1 clone</t>.",_typename];
...
hint parseText format["%1 <t size='1.0' font='PuristaMedium' color='#00ffee'> code name %2 </t> has arrived.",name _unit,_typename];
bon_recruit_queue = bon_recruit_queue - [_queuepos];
