// "LoadoutAdjustments_Group.sqf" //
private ["_unit"];
if ("BI_CP_LoadoutAdjustments" call BIS_fnc_getParamValue isEqualTo 1) exitWith {};

switch ("BI_CP_LoadoutAdjustments" call BIS_fnc_getParamValue) do {
				...
				switch true do 
				
					{
						case (side _unit isEqualTo WEST) :  {
							...
							[playerSide, "HQ"] commandChat format ["%1, Loadout Adjustments Not Enabled!",name _unit];
