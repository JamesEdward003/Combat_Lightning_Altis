////////////////////////////////////////////////////////////////////////////
// =======================================================================================
// PLAYER GROUP WILL BE TELEPORTED WITH ALT - Home press
// =======================================================================================
    ...
    switch (_dikCode) do {
        ...
        case 199 : {
	        ...
	        if (_alt) then {
	     		...
	     		if (tport2) then {tport2 = false;execVM "onMapClickTeleportGroup.sqf";};
				_handled = true;		
				};	
...
waituntil {!isnull (finddisplay 46)};
(findDisplay 46) displayAddEventHandler ["KeyDown","_this call TELEPORT_GROUP_KEYDOWN_FNC;false;"];

waitUntil {!(isNull (findDisplay 46))};
(findDisplay 46) displayAddEventHandler ["KeyUp", "tport2 = true;false;"];
...
player addEventHandler ["Respawn", {
	...
	_unit execVM "Alt_TransportGroup.sqf";
}];
*/
...
for "_i" from 0 to count (if ismultiplayer then {playableunits} else {switchableunits}) - 1 do
{
	...
	if ((isPlayer _unit) && (isFormationLeader _unit)) then {
		...
		call Alt_TeleportGroup;

		hintSilent composeText ["Alt-Home Teleport Group Keypress Enabled", lineBreak, "Press Alt-Home"];

		[playerSide, "HQ"] commandChat "Alt-Home Teleport Group Keypress Enabled!";
	};
};						
