////////////////////////////////////////////////////////////////////////////
// =======================================================================================
// PLAYER GROUP WILL BE TELEPORTED WITH ALT - T press
// =======================================================================================
...
player addEventHandler ["Respawn", {
	...
	_unit execVM "AltT_TransportGroup.sqf";
}];
*/
...
for "_i" from 0 to count (if ismultiplayer then {playableunits} else {switchableunits}) - 1 do
{
	...
	if ((isPlayer _unit) && (isFormationLeader _unit)) then {
		...
		call AltT_TeleportGroup;

		hintSilent composeText ["Alt-T Teleport Group Keypress Enabled", lineBreak, "Press Alt-T"];

		[playerSide, "HQ"] commandChat "Alt-T Teleport Group Keypress Enabled!";
	};
};						
